package com.lty.fsb.job.service.impl;
...
import com.lty.fsb.job.dao.JobMapper;
import com.lty.fsb.job.domain.Job;
import com.lty.fsb.job.service.JobService;
import com.lty.fsb.job.util.ScheduleUtils;
...
public class JobServiceImpl extends ServiceImpl<JobMapper, Job> implements JobService {
    ...
    public IPage<Job> findJobs(QueryRequest request, Job job) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "createTime", FsbConstant.ORDER_DESC, true);
