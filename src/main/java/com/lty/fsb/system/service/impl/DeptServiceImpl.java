...
import com.lty.fsb.common.domain.Tree;
import com.lty.fsb.common.utils.SortUtil;
import com.lty.fsb.common.utils.TreeUtil;
import com.lty.fsb.system.dao.DeptMapper;
...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements DeptService {
    ...
    public List<Dept> findDepts(Dept dept, QueryRequest request) {
        ...
        SortUtil.handleWrapperSort(request, queryWrapper, "orderNum", FsbConstant.ORDER_ASC, true);
