...
import com.lty.fsb.system.domain.RoleMenu;
import com.lty.fsb.system.service.RoleMenuServie;
...
public class RoleController extends BaseController {
    ...
    public void addRole(@Valid Role role) throws FsbGlobalException {
        try {
    ...
    public void deleteRoles(@NotBlank(message = "{required}") @PathVariable String roleIds) throws FsbGlobalException {
        try {
    ...
    public void updateRole(Role role) throws FsbGlobalException {
        try {
    ...
    public void export(QueryRequest queryRequest, Role role, HttpServletResponse response) throws FsbGlobalException {
        try {
