...
public class UserController extends BaseController {
    ...
    public void addUser(@Valid User user) throws FsbGlobalException {
        try {
    ...
    public void updateUser(@Valid User user) throws FsbGlobalException {
        try {
    ...
    public void deleteUsers(@NotBlank(message = "{required}") @PathVariable String userIds) throws FsbGlobalException {
        try {
    ...
    @PutMapping("profile")
    public void updateProfile(@Valid User user) throws FsbGlobalException {
        try {
    ...
    public void updateAvatar(
            ...
            @NotBlank(message = "{required}") String avatar) throws FsbGlobalException {
        try {
    ...
    public void updateUserConfig(@Valid UserConfig userConfig) throws FsbGlobalException {
        try {
    ...
    public void updatePassword(
            @NotBlank(message = "{required}") String username,
            @NotBlank(message = "{required}") String password) throws FsbGlobalException {
        try {
    ...
    public void resetPassword(@NotBlank(message = "{required}") String usernames) throws FsbGlobalException {
        try {
    ...
    public void export(QueryRequest queryRequest, User user, HttpServletResponse response) throws FsbGlobalException {
        try {
