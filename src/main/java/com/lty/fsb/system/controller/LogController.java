...
import com.lty.fsb.system.domain.SysLog;
import com.lty.fsb.system.service.LogService;
...
public class LogController extends BaseController {
    ...
    public void deleteLogss(@NotBlank(message = "{required}") @PathVariable String ids) throws FsbGlobalException {
        try {
    ...
    public void export(QueryRequest request, SysLog sysLog, HttpServletResponse response) throws FsbGlobalException {
        try {
