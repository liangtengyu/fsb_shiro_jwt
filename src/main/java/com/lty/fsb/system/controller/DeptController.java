...
import com.lty.fsb.system.service.DeptService;
...
public class DeptController extends BaseController {
    ...
    public void addDept(@Valid Dept dept) throws FsbGlobalException {
        try {
    ...
    public void deleteDepts(@NotBlank(message = "{required}") @PathVariable String deptIds) throws FsbGlobalException {
        try {
    ...
    public void updateDept(@Valid Dept dept) throws FsbGlobalException {
        try {
    ...
    public void export(Dept dept, QueryRequest request, HttpServletResponse response) throws FsbGlobalException {
        try {
